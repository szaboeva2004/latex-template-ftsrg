...
\section{Analysis of Structural Complexity and Performance}
...
\section{Impact of Optimization on Verification Efficiency}
...
\begin{itemize}
    ...
    \item \textbf{Tool Versioning:} The experiments were conducted with specific versions of \textsc{Theta} (6.27.12) and \textsc{MathSAT} (5.6.10). Changes in these tools could influence performance outcomes.
