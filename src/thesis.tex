...
\newcommand{\vikcim}{Btor2 Frontend Fejlesztése a Theta Modellellenőrzőhöz} % Cím
\newcommand{\viktanszek}{\bmemit} % Tanszék
%\newcommand{\vikdoktipus}{\bsc} % Dokumentum típusa (\bsc vagy \msc)
\newcommand{\vikmunkatipusat}{önálló laboratóriumot} % a "hallgató nyilatkozat" részhez: szakdolgozatot vagy diplomatervet
